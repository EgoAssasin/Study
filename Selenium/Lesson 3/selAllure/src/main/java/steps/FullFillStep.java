 ...
 */
public class FullFillStep extends BaseStep {

    @Step("Поле {0} заполняется значением {1}")
    public void stepFullFill(String fildName,String value){
        new FullFillPage(driver).fullFillPole(fildName,value);
    }
    ...
    public void checkFullField(String field, String value){
        String actualDataInPole = new FullFillPage(driver).getFillPole(field);
